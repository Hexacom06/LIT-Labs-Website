          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3 group">
                <MapPin className="h-5 w-5 text-gray-400 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  123 Tech Park, Innovation Street
                </span>
              </li>
              <li className="flex items-center space-x-3 group">
                <Phone className="h-5 w-5 text-gray-400 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  +91 98765 43210
                </span>
              </li>
              <li className="flex items-center space-x-3 group">
                <Mail className="h-5 w-5 text-gray-400 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  info@edutech.com
                </span>
              </li>
              <li className="flex items-center space-x-3 group">
                <Globe className="h-5 w-5 text-gray-400 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  www.edutech.com
                </span>
              </li>
