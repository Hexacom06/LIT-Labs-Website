      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center">
              {getVisibleSlides().map((slide, index) => (
                ...
                >
                  <div className="relative group rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-[1.02]">
                    <img
                      src={slide.image}
                      alt={slide.title}
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-3 rounded-full shadow-lg transition-all duration-200 z-30"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-3 rounded-full shadow-lg transition-all duration-200 z-30"
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {labSetups.map((lab) => (
              <div 
                key={lab.name}
                className="group overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl bg-white"
              >
        ...
        <div className="bg-[#f5f5f5] rounded-xl overflow-hidden">
          <div className="px-6 py-10 md:py-10 text-center">
            <h3 className="text-2xl md:text-[28px] font-bold mb-6 text-gray-900 max-w-3xl mx-auto">
              Transform your school with cutting-edge learning. Book a Free Consultation today!
            </h3>
            <button 
              className="bg-[#2196F3] hover:bg-[#1976D2] text-white px-[30px] py-[15px] rounded-[4px] font-semibold transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >
              Get Started
            </button>
          </div>
