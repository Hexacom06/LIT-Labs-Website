      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen flex flex-col justify-center">
        ...
        >
          ...
          >
            ...
            <button className="relative px-8 py-4 text-lg font-medium rounded-full bg-white text-[#004e92] hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-500 hover:text-white border border-white transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl">
              Contact Us
            </button>
          </motion.div>
        </motion.div>
